		...
		<div class="website-container">
				...
				<div class="banner">
					...
					<div class="banner-img">
						<div class="banner-img-container">
							<img alt="" src="public/images/student.png">
							...
							<div class="pattern">
								<img alt="" src="public/images/pattern.png">
							</div>
			...
			<section class="partners">
				...
				<div class="owl-carousel owl-theme partners-slider">
					...
					<div class="item brand-item">
						<img alt="" src="public/images/matoontapa.png">
					</div>
					<div class="item brand-item">
						<img alt="" src="public/images/khostan.png">
					</div>
					<div class="item brand-item">
						<img alt="" src="public/images/etimadya.png">
					</div>
					<div class="item brand-item">
						<img alt="" src="public/images/torghar.png">
					</div>
					<div class="item brand-item">
						<img alt="" src="public/images/nadershakot.png">
					</div>
					<div class="item brand-item">
						<img alt="" src="public/images/almarah.png">
					</div>
					...
					<div class="item testimonials-item">
						<div class="profile">
							<div class="profile-image">
								<img alt="" src="public/images/student-1.jpg">
							</div>
			...
			<section class="footer" id="footer">
					...
					<div class="footer-col footer-col-2">
						...
						<div class="col-contents">
							<div class="contact-row">
								<span>Address</span>
								<span>class CodeCraft, Youcode, Youssofia</span>
							</div>
							<div class="contact-row">
								<span>Phone</span>
								<span>+212 650 052037</span>
							</div>
							<div class="contact-row">
								<span>Website</span>
								<span>####################.com</span>
							...
							<div class="contact-row">
								<span>Email</span>
								<span>ridasersif1@gmail.com</span>
							</div>
						</div>
					</div>
				...
				<div class="copy-rights">
					<p>Created By <b>RIDA SERSIF</b> All Rights Reserved</p>
				</div>
